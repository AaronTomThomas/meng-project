# SST-2 Downstream GLUE-Style Adapter Evaluation
...
The suite currently supports a subset of GLUE. This readme covers the SST-2 task.
...
See `rte.md` for the RTE task runbook.
