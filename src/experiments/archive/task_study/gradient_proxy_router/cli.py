...
from experiments.archive.task_study.gradient_proxy_router.datasets import router_dataset_main
from experiments.archive.task_study.gradient_proxy_router.eval import eval_main
...
COMMANDS: dict[str, tuple[str, Callable[[list[str] | None], None]]] = {
    "build-router-dataset": ("Build the full router-ready dataset.", router_dataset_main),
